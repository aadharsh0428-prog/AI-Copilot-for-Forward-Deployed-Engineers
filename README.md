...
![Home page — Workshop Copilot ready state](ui-one.png)
...
![Workflow extraction — Finance team daily Ramp review](ui-two.png)
...
![Agent Design tab — Ramp Expense Review Agent](ui-three.png)
...
![Spec tab — Implementation tickets and rollout](ui-four.png)
